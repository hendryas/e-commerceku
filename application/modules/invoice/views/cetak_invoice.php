...
<head>
  ...
  <!--==============================
	...
	============================== -->
  <!-- Bootstrap -->
  <link rel="stylesheet" href="<?= base_url('assets/invar/assets/css/bootstrap.min.css'); ?>">
  <!-- Theme Custom CSS -->
  <link rel="stylesheet" href="<?= base_url('assets/invar/assets/css/style.css') ?>">
...
==============================-->
              ...
              <div class="row align-items-center justify-content-between">
                <div class="col-auto">
                  <div class="header-logo">
                    <!-- <a href="#"><img src="<?= base_url('assets/invar/assets/img/logo-train.svg') ?>" alt="Invar">EcommerceKu</a> -->
                  </div>
                </div>
                <div class="col-auto">
                  <h1 class="big-title">Invoice</h1>
                  <p class="invoice-number"><b>Invoice No: </b>#<?php echo $data_invoice['no_order']; ?></p>
                </div>
              </div>
            </header>
            <hr class="style1">
            <div class="row justify-content-between mb-4">
              <div class="col-auto">
                <div class="invoice-left">
                  <b>Must Read:</b>
                  <address>
                    Invoice ini berlaku sebagai bukti resmi <br> atas transaksi yang terjadi
                    antara pihak <br> penjual dan pembeli pada tanggal yang tertera, <br>
                    serta menjadi dasar untuk proses pembayaran <br>
              ...
              <div class="col-auto">
                <div class="invoice-right">
                  <b>Penerima:</b>
                  <address>
                    <?php echo $data_invoice['nama_penerima']; ?>, <br>
                    <?php echo $data_invoice['alamat_penerima']; ?> <br>
                    <?php echo $data_invoice['hp_penerima'] ?> <br>
                  </address>
                </div>
              </div>
            </div>
            <hr class="style1">
            <p class="table-title text-center"><b>Detail Pesanan:</b></p>
            <table class="invoice-table table-stripe4 theme-color">
              ...
              <tbody>
                <?php $no = 1; ?>
                <?php foreach ($data_invoice_product as $invoice_product) : ?>
                  <tr>
                    <td><?php echo $no; ?></td>
                    <td><?php echo $invoice_product['nama_barang'] ?></td>
                    <td>Rp <?php echo number_format($invoice_product['harga']); ?></td>
                    <td><?php echo $invoice_product['qty'] ?></td>
                  </tr>
                  <?php $no++; ?>
                <?php endforeach; ?>
              </tbody>
            ...
            <div class="body-shape1">
              <svg width="850" height="200" viewBox="0 0 850 200" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M850 0V200L770.414 66.0637L403.561 65.9779L377.479 45.3821L320 0H850Z" fill="#7539FF" />
              </svg>
            </div>
          </div>
...
============================== -->
  <!-- Jquery -->
  <script src="<?= base_url('assets/invar/assets/js/vendor/jquery-3.6.0.min.js') ?>"></script>
  <!-- Bootstrap -->
  <script src="<?= base_url('assets/invar/assets/js/bootstrap.min.js') ?>"></script>
  <!-- PDF Generator -->
  <script src="<?= base_url('assets/invar/assets/js/jspdf.min.js') ?>"></script>
  <script src="<?= base_url('assets/invar/assets/js/html2canvas.min.js') ?>"></script>
  <!-- Main Js File -->
  <script src="<?= base_url('assets/invar/assets/js/main.js'); ?>"></script>
